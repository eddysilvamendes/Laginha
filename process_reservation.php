...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'edilson.mendes@primeconsulting.org'  =>
            ['#subject#' => 'Pedido de Reserva RESIDENCIAL LAGINHA']

        $email =>
            ['#subject#' => 'RESIDENCIAL LAGINHA Reservation Request',
...
<title>RESIDENCIAL LAGINHA </title>
</head>
...
center">Pedido de Reserva RESIDENCIAL LAGINHA</h1>
</td>
</tr>
<tr>
